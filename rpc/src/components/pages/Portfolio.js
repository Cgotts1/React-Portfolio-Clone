...
//           <a
//             href="https://github.com/Cgotts1/Tech-Blog"
//             target="_blank"
//           >
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
...
//             fill="currentColor"
//             className="bi bi-github overlay overlay-logo tech-used"
//             onClick={toggleVisibility13}            
//             viewBox="0 0 16 16">
//             <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z" />
//           </svg> 

//           {isVisible13 && <div className="project-summary">A tech blog application that allows users to make an account and engage with other users through creating and commenting on posts. </div>}

//           {/* ---------------------------------------------------------- */}
//           <h6 className="description-and-tech">🛠 HTML | CSS | JS | MySQL<br></br> Express | Handlebars.js</h6>

//           <a href="https://tech-blog-cgotts1.herokuapp.com/" target="_blank">
//             <img
//               src={image18}
//               alt="Tech Blog"
//               id="full-stack-work"
...
//           <a
//             href="https://github.com/Cgotts1/Note-Taker-Responsive"
//             target="_blank"
//           >
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
...
//             fill="currentColor"
//             className="bi bi-github overlay overlay-logo tech-used"
//             onClick={toggleVisibility14}            
//             viewBox="0 0 16 16">
//             <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z" />
//           </svg> 

//           {isVisible14 && <div className="project-summary">A note taking application that is user-friendly, responsive, and efficient in storing and managing notes using Express and Node.js technologies.</div>}

//           {/* ---------------------------------------------------------- */}
//           <h6 className="description-and-tech">🛠 HTML | CSS | JS <br></br> Express | Node.js</h6>

//           <a href="https://note-taker-responsive.herokuapp.com/" target="_blank">
//             <img
//               src={image2}
//               alt="Tech Blog"
//               id="full-stack-work"
...
{/* <div className="portfolio-container fadeIn">
       ...
       <div id="full-stack-works" className="works">
      {projects.map((project, index) => (
        <article className="work1" key={index}>
          ...
          <p id="full-stack-overlay" className="overlay">
           ...
           <a href={project.projectSite} target='_blank'>
          <img src={project.projectImage} alt={project.projectName} id="full-stack-work" className="work"/>
          </a>
          ...
          <div className="project-summary">{project.projectSummary}</div>
           <h6 className="description-and-tech">{project.projectTech} </h6>

          <a href={project.projectGitHub} target='_blank'> <svg
               xmlns="http://www.w3.org/2000/svg"
               width="100"
               height="100"
               fill="currentColor"
